...
def validate_ci() -> None:
    ...
    require_markers(
        workflow,
        {
            ...
            "--publish 5672:5672",
            "--publish 15672:15672",
            "RABBITMQ_DEFAULT_USER=groovemap",
            "RABBITMQ_DEFAULT_PASS=groovemap",
